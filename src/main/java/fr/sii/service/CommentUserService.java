...
public class CommentUserService {
    ...
    public List<CommentUser> findAll(int userId, int talkId) {
        List<Comment> comments = commentRepo.findByTalkIdAndTalkUserId(talkId, userId);
    ...
    public CommentUser editComment(int userId, int talkId, CommentUser commentUser) {
        Comment comment = commentRepo.findByIdAndTalkIdAndTalkUserId(commentUser.getId(), talkId, userId);
